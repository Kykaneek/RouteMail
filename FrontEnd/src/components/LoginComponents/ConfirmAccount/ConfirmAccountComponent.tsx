...
export default function  ConfirmAccountCodeComponent({ navigation }: { navigation: any }) {
  ...
  const handleSignUp = () => {
    // Tutaj dodaj nawigację do ekranu rejestracji
    console.log('Sign up');
  };
  ...
  <TouchableOpacity onPress={handleSignIn}>
    <View style={styles.btn}>
      <Text style={styles.btnText}>Nadaj hasło</Text>
    </View>
  </TouchableOpacity>
...
const ConfirmAccountCodeComponent = ({ navigation }: { navigation: any }) => {
  return (
...
export default ConfirmAccountCodeComponent;
*/