...
export default function ConfirmPassword({ navigation }: { navigation: any }) {
  ...
  const handleSignIn = () => {
    // Tutaj dodaj logikę logowania, np. wysłanie danych formularza do serwera
  ...
  <TouchableOpacity onPress={handleSignIn}>
    <View style={styles.btn}>
      <Text style={styles.btnText}>Wyślij kod odzysku na email</Text>
    </View>
  </TouchableOpacity>

  
  <TouchableOpacity onPress={codeVerify}>
    <View style={styles.btn}>
      <Text style={styles.btnText}>Zweryfikuj kod</Text>
    </View>
  </TouchableOpacity>

  <TouchableOpacity onPress={returnToLog}>
    <View style={styles.btn}>
