...
export const getOrderById = (req, res) => {
  ...
  db.query('SELECT * FROM Orders WHERE id = ?', [orderId], (error, results, fields) => {
    if (error) throw error;
    if (results.length === 0) {
...
export const createOrder = (req, res) => {
  ...
  db.query('INSERT INTO Orders SET ?', order, (error, results, fields) => {
    if (error) throw error;
...
export const updateOrder = (req, res) => {
  ...
  db.query('UPDATE Orders SET ? WHERE id = ?', [updatedOrder, orderId], (error, results, fields) => {
    if (error) throw error;
...
export const deleteOrder = (req, res) => {
  const orderId = req.params.id;
  db.query('DELETE FROM Orders WHERE id = ?', [orderId], (error, results, fields) => {
    if (error) throw error;
...
export const getAllOrderItems = (req, res) => {
  db.query('SELECT * FROM OrderItem', (error, results, fields) => {
    if (error) throw error;
    res.json(results);
  });
};
...
export const getOrderItemById = (req, res) => {
  ...
  db.query('SELECT * FROM OrderItem WHERE id = ?', [orderItemId], (error, results, fields) => {
    if (error) throw error;
    if (results.length === 0) {
...
export const createOrderItem = (req, res) => {
  ...
  db.query('INSERT INTO OrderItem SET ?', orderItem, (error, results, fields) => {
    if (error) throw error;
...
export const updateOrderItem = (req, res) => {
  ...
  db.query('UPDATE OrderItem SET ? WHERE id = ?', [updatedOrderItem, orderItemId], (error, results, fields) => {
    if (error) throw error;
...
export const deleteOrderItem = (req, res) => {
  const orderItemId = req.params.id;
  db.query('DELETE FROM OrderItem WHERE id = ?', [orderItemId], (error, results, fields) => {
    if (error) throw error;
